  ...
  return (
    <div className=''>
      <div className='routes d-flex'>
        <div className=' row '>
        <div className='col-sm-3  col-lg-7 p-5'>
          <h1>connecting Talents Here</h1>
          <h2>Build Network With our Website </h2>
          <h6>connect,contact,evovle</h6>
        </div>
        <div className='col-sm-4  col-lg-5  '>
       <div className="row m-2">
        <div className="col-lg-6"  >
          <button type='click' onClick={()=>navigate('/Learning')} className='btnn btn w-100 h-100'>
            <div className="card d-block w-100 h-100 m-auto" >
            <img   src="https://cdn.unstop.com/uploads/images/home/home-hero-learn.png?d=324x406"
        ...
        <div className="col-lg-6">
        <button type='click' onClick={()=>navigate('/Mentoring')} className='btnn btn'>
          <div className="card d-block  w-100 h-100 m-auto" >
            <img   src="https://cdn.unstop.com/uploads/images/courses/unstop-classroom-banner-new.png?d=840x870"
             alt="" width={150} height={150}/>
             <b>Mentoring</b>
       ...
       <div className="row m-2">
        <div className="col-lg-6 ">
        <button type='click' onClick={()=>navigate('/Practice')} className='btnn btn'>
          <div className="card d-block w-100 h-100 m-auto " >
            <img   src="https://cdn.unstop.com/uploads/images/home/home-hero-practice.png?d=324x406"
             alt="" width={150} height={150}/>
              Practice
          </div >
        ...
        <div className="col-lg-6">
        <button type='click' onClick={()=>navigate('/Jobs')} className='btnn btn'>
          <div className="card d-block w-100 h-100 m-auto" >
            <img   src="https://cdn.unstop.com/uploads/images/home/home-hero-jobs.png?d=324x406"
             alt=""  width={150} height={150}/>
                 jobs
          </div >
          </button>
...
<Carousel  className='p-3'>
      ...
      <div class="row mt-5">
            <div class="col-4  bg-opacity-50 text-center border border-5 p-3 border-white " >
            <button className='btn cardss' type='click' onClick={()=>navigate('/Courses')}>
                <img src="https://cdn.unstop.com/uploads/images/home/home-hero-compete.png?d=324x406" alt="" width={250} height={250} />
                <h5>Compete</h5>
            ...
            <div class="col-4  bg-opacity-50 text-center border border-5 p-3 border-white " >
            <button className='btn cardss' type='click' onClick={()=>navigate('/Courses')}>
                <img src="data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoGBxMTERISEhEYFhEUGRIWGBYWFhoaERERFhYY
                ...
                WAAFhYAAWFgABYWAAFhYAAWFgABYWAAFhYAAWFgABYWAAFhYAAWFgABYWAAFhYAAWFgABYWAAAAKg//Z" alt="" width={250} height={250} />
                <h5>Compete</h5>
                <h6 style={{textDecoration:'underline'}}>Time to learn</h6>
                </button>
            </div>
            <div class="col-4  bg-opacity-100 text-center border border-5 p-3 border-white " >
            <button className='btn cardss' type='click' onClick={()=>navigate('/Courses')}>
                <img src="data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAkGBxIPDxAPEBIQEA8QDRYODw8QDxAPFRASFRIWFxUSFRoYHSggGBslHRUVIjEiJSkrLi4uGB8zODMsNy
                ...
                sXVt8E6Oi6tvgrtEuxYojjDQGtAAGgCrRFBJ//2Q==" alt="" width={250} height={250} />
                <h5>Compete</h5>
                <h6 style={{textDecoration:'underline'}}>Time to learn</h6>
                </button>
            </div>
